...
- [docs/AUTHENTICATION_AND_SESSIONS.md](docs/AUTHENTICATION_AND_SESSIONS.md)
- [docs/PUBLIC_ENDPOINTS.md](docs/PUBLIC_ENDPOINTS.md)
- [docs/INTERNAL_OR_INACTIVE_MODULES.md](docs/INTERNAL_OR_INACTIVE_MODULES.md)
...
- [docs/STAFF_AND_DEVELOPER_SURFACES.md](docs/STAFF_AND_DEVELOPER_SURFACES.md)
...
|---|---|---|
| API Integrators | [docs/API_CONTRACTS.md](docs/API_CONTRACTS.md) | [docs/AUTHENTICATION_AND_SESSIONS.md](docs/AUTHENTICATION_AND_SESSIONS.md), [docs/PUBLIC_ENDPOINTS.md](docs/PUBLIC_ENDPOINTS.md), [docs/REPORTING_ENDPOINTS.md](docs/REPORTING_ENDPOINTS.md) |
...
| Customer Experience | [docs/COUPONS_AND_FAVORITES.md](docs/COUPONS_AND_FAVORITES.md) | [docs/PAYMENTS_AND_BANK_TRANSFER.md](docs/PAYMENTS_AND_BANK_TRANSFER.md), [docs/NOTIFICATIONS_MODEL.md](docs/NOTIFICATIONS_MODEL.md) |
